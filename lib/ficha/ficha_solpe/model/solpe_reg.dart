...
class SolPeReg {
  ...
  SolPeReg copyWith({
    ...
    return SolPeReg(
      ...
      pedidofinal: pedidofinal ?? this.pedidofinal,
      pdi: pdi ?? this.pdi,
  ...
  factory SolPeReg.fromMap(Map<String, dynamic> map) {
    return SolPeReg(
      ...
      pedidofinal: map['pedidofinal'].toString(),
  ...
  @override
  String toString() {
    return 'SolPeReg(id: $id, pedidonumber: $pedidonumber, pos: $pos, e4e: $e4e, descripcion: $descripcion, um: $um, ctds: $ctds, ctdp: $ctdp, pedido: $pedido, pedidofinal: $pedidofinal, pdi: $pdi, proyecto: $proyecto, circuito: $circuito, ecpersona: $ecpersona, ecfecha: $ecfecha, eccomentario: $eccomentario, enelpersona: $enelpersona, enelfecha: $enelfecha, enelcomentario: $enelcomentario, estado: $estado, estadofecha: $estadofecha)';
  }
  ...
  Color pedidoColor = Colors.black;
  Color pedidofinalColor = Colors.black;
  ...
  String get errors {
    ...
    if (pedidoError.isNotEmpty) errors += 'PEDIDO: $pedidoError, ';
    if (pedidofinalError.isNotEmpty) errors += 'PEDIDO(f): $pedidofinalError, ';
    return errors;
  }
  ...
  Color get errorColor {
    ...
    if (pedidoColor != Colors.black && errorColor != Colors.red) {
      errorColor = pedidoColor;
    }
    if (pedidofinalColor != Colors.black && errorColor != Colors.red) {
      errorColor = pedidofinalColor;
    }
    return errorColor;
  }
  ...
  setWithEnum({
    ...
    if (tipo == CampoSolpe.ctdp) ctdp = aEntero(value);
    ...
    if (tipo == CampoSolpe.pedidofinal) pedidofinal = value;
  }
}
