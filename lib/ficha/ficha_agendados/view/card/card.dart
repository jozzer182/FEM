...
import '../dialogos/pdi_seleccionar.dart';
import '../dialogos/wbe_seleccionar.dart';
import 'card_number.dart';

class CardPedido extends StatefulWidget {
  final SingleFEM fem;
  final SingleFEM oldFem;
...
class _CardPedidoState extends State<CardPedido> {
  ...
  Widget build(BuildContext context) {
    SingleFEM singleFEM = widget.fem;
    bool isEdit = context.read<MainBloc>().state.ficha!.fichaPedidos.editar;
    return Card(
      elevation: 2.0,
      child: Padding(
            ...
            SizedBox(
              ...
              child: Row(
                children: [
                            ...
                            Row(
                              children: [
                                FieldTexto(
                                  flex: 1,
                                  size: 14,
                                  edit: edit && !isNotRequired,
                                  opciones: wbes,
                                  label: 'Wbe',
                                  color: wbeColor,
                                  colorfondo: wbeFillColor,
                                  initialValue: singleFEM.wbe,
                                  asignarValor: (valor) {
                                    if (valor.isNotEmpty) {
                                      if (wbes.contains(valor)) {
                                  ...
                                  child: ElevatedButton(
                                    onPressed: () {
                                      showDialog(
                                        context: context,
                                        builder: (context) {
                                          return WbeDescripcionAgendadosDialog(
                                            singleFEM: singleFEM,
                                          );
                                        },
                                      );
                  ...
                  FichaPedidosNumber(
                    item: singleFEM.item,
                    q1: aEntero(singleFEM.m01q1),
                    q2: aEntero(singleFEM.m01q2),
                    b1: singleFEM.pedido[0] == '1',
                    b2: singleFEM.pedido[1] == '1',
                    qx: singleFEM.m01qx,
                    estadoPed: widget.dates['01']!,
                    mes: widget.oldFem.mes01,
                  ),
                  const Gap(1),
                  FichaPedidosNumber(
                    item: singleFEM.item,
                    q1: aEntero(singleFEM.m02q1),
                    q2: aEntero(singleFEM.m02q2),
                    b1: singleFEM.pedido[2] == '1',
                    b2: singleFEM.pedido[3] == '1',
                    qx: singleFEM.m02qx,
                    estadoPed: widget.dates['02']!,
                    mes: widget.oldFem.mes02,
                  ),
                  const Gap(1),
                  FichaPedidosNumber(
                    item: singleFEM.item,
                    q1: aEntero(singleFEM.m03q1),
                    q2: aEntero(singleFEM.m03q2),
                    b1: singleFEM.pedido[4] == '1',
                    b2: singleFEM.pedido[5] == '1',
                    qx: singleFEM.m03qx,
                    estadoPed: widget.dates['03']!,
                    mes: widget.oldFem.mes03,
                  ),
                  const Gap(1),
                  FichaPedidosNumber(
                    item: singleFEM.item,
                    q1: aEntero(singleFEM.m04q1),
                    q2: aEntero(singleFEM.m04q2),
                    b1: singleFEM.pedido[6] == '1',
                    b2: singleFEM.pedido[7] == '1',
                    qx: singleFEM.m04qx,
                    estadoPed: widget.dates['04']!,
                    mes: widget.oldFem.mes04,
                  ),
                  const Gap(1),
                  FichaPedidosNumber(
                    item: singleFEM.item,
                    q1: aEntero(singleFEM.m05q1),
                    q2: aEntero(singleFEM.m05q2),
                    b1: singleFEM.pedido[8] == '1',
                    b2: singleFEM.pedido[9] == '1',
                    qx: singleFEM.m05qx,
                    estadoPed: widget.dates['05']!,
                    mes: widget.oldFem.mes05,
                  ),
                  const Gap(1),
                  FichaPedidosNumber(
                    item: singleFEM.item,
                    q1: aEntero(singleFEM.m06q1),
                    q2: aEntero(singleFEM.m06q2),
                    b1: singleFEM.pedido[10] == '1',
                    b2: singleFEM.pedido[11] == '1',
                    qx: singleFEM.m06qx,
                    estadoPed: widget.dates['06']!,
                    mes: widget.oldFem.mes06,
                  ),
                  const Gap(1),
                  FichaPedidosNumber(
                    item: singleFEM.item,
                    q1: aEntero(singleFEM.m07q1),
                    q2: aEntero(singleFEM.m07q2),
                    b1: singleFEM.pedido[12] == '1',
                    b2: singleFEM.pedido[13] == '1',
                    qx: singleFEM.m07qx,
                    estadoPed: widget.dates['07']!,
                    mes: widget.oldFem.mes07,
                  ),
                  const Gap(1),
                  FichaPedidosNumber(
                    item: singleFEM.item,
                    q1: aEntero(singleFEM.m08q1),
                    q2: aEntero(singleFEM.m08q2),
                    b1: singleFEM.pedido[14] == '1',
                    b2: singleFEM.pedido[15] == '1',
                    qx: singleFEM.m08qx,
                    estadoPed: widget.dates['08']!,
                    mes: widget.oldFem.mes08,
                  ),
                  const Gap(1),
                  FichaPedidosNumber(
                    item: singleFEM.item,
                    q1: aEntero(singleFEM.m09q1),
                    q2: aEntero(singleFEM.m09q2),
                    b1: singleFEM.pedido[16] == '1',
                    b2: singleFEM.pedido[17] == '1',
                    qx: singleFEM.m09qx,
                    estadoPed: widget.dates['09']!,
                    mes: widget.oldFem.mes09,
                  ),
                  const Gap(1),
                  FichaPedidosNumber(
                    item: singleFEM.item,
                    q1: aEntero(singleFEM.m10q1),
                    q2: aEntero(singleFEM.m10q2),
                    b1: singleFEM.pedido[18] == '1',
                    b2: singleFEM.pedido[19] == '1',
                    qx: singleFEM.m10qx,
                    estadoPed: widget.dates['10']!,
                    mes: widget.oldFem.mes10,
                  ),
                  const Gap(1),
                  FichaPedidosNumber(
                    item: singleFEM.item,
                    q1: aEntero(singleFEM.m11q1),
                    q2: aEntero(singleFEM.m11q2),
                    b1: singleFEM.pedido[20] == '1',
                    b2: singleFEM.pedido[21] == '1',
                    qx: singleFEM.m11qx,
                    estadoPed: widget.dates['11']!,
                    mes: widget.oldFem.mes11,
                  ),
                  const Gap(1),
                  FichaPedidosNumber(
                    item: singleFEM.item,
                    q1: aEntero(singleFEM.m12q1),
                    q2: aEntero(singleFEM.m12q2),
                    b1: singleFEM.pedido[22] == '1',
                    b2: singleFEM.pedido[23] == '1',
                    qx: singleFEM.m12qx,
                    estadoPed: widget.dates['12']!,
                    mes: widget.oldFem.mes12,
                  ),
                  const Gap(1),
                  Expanded(
                    flex: 1,
                    child: Column(
                      ...
                      children: [
                        Text(
                          singleFEM.totalped.toString(),
                          style: TextStyle(
                            fontSize: 12,
                            color: singleFEM.totalped == 0
                                ? Colors.grey
