...
class CodigosAdicionalesEdit extends StatefulWidget {
  final CodigoAdicional? codigoAdicional;
  const CodigosAdicionalesEdit({
    this.codigoAdicional,
    super.key,
  });

  @override
  State<CodigosAdicionalesEdit> createState() => _CodigosAdicionalesEditState();
}

class _CodigosAdicionalesEditState extends State<CodigosAdicionalesEdit> {
  bool esNuevo = false;
  ...
  @override
  void initState() {
    if (widget.codigoAdicional == null) {
      esNuevo = true;
      title = 'Agregar Código Adicional';
    } else {
      codigoController.text = widget.codigoAdicional!.e4e;
      descripcionController.text = widget.codigoAdicional!.descripcion;
      familiaController.text = widget.codigoAdicional!.familia;
      ntController.text = widget.codigoAdicional!.nt;
      umController.text = widget.codigoAdicional!.um;
      precio = widget.codigoAdicional!.precio;
      normaController.text = widget.codigoAdicional!.norma;
    }
      ...
      actions: [
        ...
        TextButton(
          onPressed: isError
              ? null
              : () {
                  context.read<MainBloc>().metodos().saveCodigoAdicional(
                        codigoAdicional: CodigoAdicional(
                          e4e: codigoController.text,
                          descripcion: descripcionController.text,
                          familia: familiaController.text,
  ...
  void validadorCodigo(
    ...
    if (es6digitos && esNuevo) {
      CodigoOficial codigoOficial = codigosOficiales.firstWhere(
          (e) => e.e4e == codigoController.text,
          orElse: () => CodigoOficial.fromInit());
      bool esOficial = codigoOficial.e4e != '';
      CodigoAdicional codigoAdicional = codigosAdicionales.firstWhere(
          (e) => e.e4e == codigoController.text,
          orElse: () => CodigoAdicional.fromInit());
      bool esAdicional = codigoAdicional.e4e != '';
      if (esOficial) {
        codigoError = 'Oficial';
        descripcionController.clear();
        ntController.clear();
